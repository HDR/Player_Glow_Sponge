...
public class glowColor implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        if (src instanceof Player) {
            ...
            player.sendMessage(Text.of(TextStyles.BOLD, "Player Glow ", TextColors.GOLD, GlowStrings.PluginVersion, TextColors.WHITE, " By ", TextColors.GOLD, "HDR ", TextColors.RED, "http://bit.ly/2rfrBA3"));
            player.sendMessage(Text.of(TextStyles.BOLD, "Usage: ", TextColors.GOLD, "/glow color", "& ", "/glow toggle"));
